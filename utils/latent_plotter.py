...
def visualize_vae_multiple_samples(model, X, n_curves=7, n_samples=100, alpha=0.1, device='mps', iterations=10):
    """
...
if __name__ == '__main__':
    ...
    model.load_state_dict(torch.load('model_ckpts/model_alpha_div_new.pth', map_location=torch.device('cpu')))
